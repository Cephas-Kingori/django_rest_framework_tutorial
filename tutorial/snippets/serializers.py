...
#NB Model Serializer is a more efficient method than using the raw Serializer class
class SnippetSerializer(serializers.Serializer):
    #The first part of the serializer class defines the fields that get serialized/deserialized.

    #A serializer class like a Django Form class, includes similar validation flags on the various fields e.g. required, max_length, default
...
#define how fully fledged instances are modified
...
class BetterSnippetSerializer(serializers.ModelSerializer):
    class Meta:
        model = Snippet
        # could use __all__
